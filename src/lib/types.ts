/**
 * 백엔드(Supabase) 데이터 타입.
 * 실제 스키마엔 없을 수도 있는 필드는 옵셔널(?)로 두어 런타임에서 안전하게 처리한다.
 */
...
export interface Trial {
  ...
  photo_uris?: string[] | null; // 첨부 사진 여러 장 (Storage 업로드 URL 배열)
